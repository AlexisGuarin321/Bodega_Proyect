...
public class ProvedorController implements Serializable {
    ...
    @EJB
    private fachada.ProvedorFacade ejbFacade;
    ...
    public Provedor getProvedor(java.lang.Integer id) {
    ...
    public static class ProvedorControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getProvedor(getKey(value));
        }
